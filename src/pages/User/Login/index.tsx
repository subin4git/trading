...
const Login: React.FC = () => {
  ...
  const [type, setType] = useState<string>('stocker');
  ...
  const handleSubmit = async (values: API.LoginParams) => {
    try {
      ...
      // 登录
      const msg = await login({ ...values, usertype:type });
      if(msg.status == 'ok'){
          ...
          <Tabs
            ...
            items={[
              ...
              },
              {
                key: 'broker',
                label: intl.formatMessage({
                  id: 'pages.login.broker.tab',
                  defaultMessage: '经纪人登录',
                }),
              },
            ]}
          />
